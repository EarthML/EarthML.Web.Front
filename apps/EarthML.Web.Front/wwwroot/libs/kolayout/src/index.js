define(["require", "exports", "knockout", "./utils/isDefined"], function (require, exports, ko, isDefined_1) {
    "use strict";
    var KoLayout = (function () {
        function KoLayout(options) {
            this.options = options;
        }
        KoLayout.prototype.templateOptions = function (element) {
            return this.options;
        };
        return KoLayout;
    }());
    exports.KoLayout = KoLayout;
    ...
    ko.bindingHandlers.koLayout = {
        init: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
            ...
            if (isDefined_1.isDefined(layout)) {
        ...
        update: function (element, valueAccessor, allBindingsAccessor, viewModel, bindingContext) {
            ...
            if (isDefined_1.isDefined(layout)) {
                var init = !isDefined_1.isDefined(ko.utils.domData.get(element, "kolayout_init"));
                if (init) {
