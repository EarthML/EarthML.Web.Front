 ...
 * http://www.codrops.com
 */
define(["require", "exports", "modernizr"], function (require, exports, Modernizr) {
    "use strict";
    function extend(a, b) {
        for (var key in b) {
    ...
    var MLPushMenu = (function () {
        ...
        function MLPushMenu(el, trigger, options) {
            ...
            this.level = 0;
            this.trigger = trigger;
            this.options = extend(MLPushMenuDefaults, options);
        ...
        MLPushMenu.prototype._init = function () {
            // the moving wrapper
        ...
        MLPushMenu.prototype._initEvents = function (eventtype) {
            var self = this;
        ...
        // close the menu
        MLPushMenu.prototype._resetMenu = function () {
        ...
        // close sub menus
        MLPushMenu.prototype._closeMenu = function () {
            var translateVal = this.options.type === 'overlap' ? this.el.offsetWidth + (this.level - 1) * this.options.levelSpacing : this.el.offsetWidth;
            this._setTransform('translate3d(' + translateVal + 'px,0,0)');
            this._toggleLevels();
        };
        // translate the el
        MLPushMenu.prototype._setTransform = function (val, el) {
            if (el === void 0) { el = this.wrapper; }
            el.style.webkitTransform = val;
            el.style.transform = val;
        };
        // removes classes mp-level-open from closing levels
        MLPushMenu.prototype._toggleLevels = function () {
            for (var i = 0, len = this.levels.length; i < len; ++i) {
                var levelEl = this.levels[i];
